...
1. **TESTVERSION:** Brug ikke den nuværende mobilversion til betalt Banko eller spil med gevinster, før Pubben har fået den konkrete model afklaret og de nødvendige tilladelser på plads.
2. Landbaseret bingo/banko kræver tilladelse, når deltagerne betaler et indskud (penge eller lignende), gevinstchancen beror på tilfældighed, og betalingen giver mulighed for at vinde en gevinst.
